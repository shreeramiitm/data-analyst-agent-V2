...
# API metadata
API_TITLE = "data analylst InsightForge"
API_DESCRIPTION = "A next-gen API that harnesses large language models to gather, refine, explore, and visualize data—seamlessly blending text, numbers, and visuals."
API_VERSION = "2.0.0"
